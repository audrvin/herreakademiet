(() => {
  ...
  var STORAGE_KEY = window.__MYTHEME_STORAGE_KEY__ || "mytheme-color-scheme";
  var DEFAULT_THEME = window.__MYTHEME_DEFAULT_THEME__ === "dark" ? "dark" : "light";
  var THEME_TOGGLE_ENABLED = window.__MYTHEME_THEME_TOGGLE_ENABLED__ !== false;
  var FIXED_THEME = window.__MYTHEME_FIXED_THEME__ === "dark" ? "dark" : "light";
